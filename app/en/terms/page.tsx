            ...
            <div className="prose prose-slate max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-700 leading-relaxed">
                  Jotto is a productivity tool that allows users to capture, organize, and manage text content. The
                  service is free to use and does not require any payment or subscription.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-700 leading-relaxed mb-4">By using Jotto, you agree not to:</p>
                <ul className="list-disc list-inside text-slate-700 space-y-2">
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-700 leading-relaxed">
                  Jotto is provided "as-is" without warranties. We are not liable for any loss of data or damage arising
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-700 leading-relaxed">
                  ...
                  for authentication. By using our app, you also agree to their{" "}
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-700 leading-relaxed">
                  We may update these terms in the future. Continued use of the app constitutes your acceptance of the
                  updated terms.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-700 leading-relaxed mb-4">If you have any questions, please contact:</p>
